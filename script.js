...
function darkMode() {
    ...
    switch (bgColor) {
        case 0:
            // Set Dark Mode
            bgColor = 1
            document.getElementById("test2").style.backgroundColor = "#101416";
            ...
            document.getElementById('switchThemeIcon').animate([
        ...
        default:
            bgColor = 0
            document.getElementById("test2").style.backgroundColor = "#f7f9fc";
...
setInterval(checkWidth, 75); // Check every 50 milliseconds
/////////////////////////////////////////////
// let x = 0
